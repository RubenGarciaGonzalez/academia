...
<div class="card bg-secondary">
    <div class="card-header text-center text-warning h3">Guardar Módulo</div>
    <div class="card-body">
        <form name="g" action="{{route('modulos.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="col">
                    ...
                    <input type="number" class="form-control" name="horas" value="{{old('horas')}}" placeholder="Horas" id="horas" min="1" step="1" required>
                </div>
            </div>
